...
class SingleDateChooser extends StatefulWidget {
  const SingleDateChooser({
    super.key,
    this.firstDate,
    this.lastDate,
  ...
  @override
  State<SingleDateChooser> createState() => _SingleDateChooserState();
}

class _SingleDateChooserState extends State<SingleDateChooser> {
